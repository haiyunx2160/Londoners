                                        ...
                                        <div class="span8 page-content">
                                                ...
                                                <ul class="breadcrumb">
                                                        ...
                                                        $postid=urldecode($_GET['postid']);
                                                                 post_data($postid);
                                                        ?>
                                                        <!-- <li><a href="index.php">Knowledge Base Theme</a><span class="divider">/</span></li>
                                                        <li><a href="category_post.php" title="View all posts in Server &amp; Database">Server &amp; Database</a> <span class="divider">/</span></li>
                                                ...
                                                <div class="like-btn">
                                                        ...
                                                        <form id="like-it-form" action="includes/postlike.php" method="post">
                                                               <?php getpostlikes($_GET['postid']);?>
                                                        ...
                                                        <div id="respond">
                                                                ...
                                                                <form action="#" method="post" id="commentform">
                                                                        ...
                                                                        <div>
                                                                                ...
                                                                                <input class="span4" type="text" name="email" id="commmentemail" value="" size="22" >
                                                                        </div>
