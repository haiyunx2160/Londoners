...
var form = $("#like-it-form");

$.ajax({
       type: "POST",
       url: "functions/post_like.php",
       ...
       success: function(data)
       {
        ...
        var v=data.trim();
           if(v=="Login"){
            ...
            likeButton.removeClass('like-btn');
            likeButton.removeClass('like-it');
            likeButton.addClass('like-btn');
            likeButton.addClass('like-it:hover');
...
function shakeModal(error){
    ...
    $('#exampleModal').addClass('error');
             $('#invalidUserName').addClass('alert alert-danger').html(error);
             $('#invalidPassword').addClass('alert alert-danger').html(error);
...
/*JOGY"S REDIRECT TO CONTAINER CATEGORY_POST */
